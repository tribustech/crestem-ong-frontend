 ...
 *
 * "Evaluare curentă" is a real link only when `currentEvaluationHref` is given.
 * Members never get one: the report endpoints behind that view are
 * `is-ngo-admin` only, so for them the tab stays disabled.
 *
...
export function EvaluationTabs({
  ...
  active: "overview" | "evaluations" | "current";
  basePath: string;
