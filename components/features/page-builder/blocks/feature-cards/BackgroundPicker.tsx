...
type Background = FeatureCardsData["background"];
...
/**
 * The "Fundal" field for Feature Cards: a 3-up grid of swatch cards, the selected
 * one outlined in blue. Same shape as Hero – Intro's picker; kept co-located
 * until a third block needs it and it can move to a shared module.
 */
